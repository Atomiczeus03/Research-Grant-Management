                ...
                <div class="p-6">
                    <form action="{{ route('projectMilestones.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="milestone_name" id="milestone_name" class="mt-1 block w-full border-blue-400 rounded-md shadow-sm text-black" required>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" name="target_completion_date" id="target_completion_date" class="mt-1 block w-full border-blue-400 rounded-md shadow-sm text-black" required>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="deliverable" id="deliverable" rows="3" class="mt-1 block w-full border-blue-400 rounded-md shadow-sm text-black" required></textarea>
                            @error('deliverable')
                                <div class="text-red-500 text-xs mt-1">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="remark" id="remark" rows="3" class="mt-1 block w-full border-blue-400 rounded-md shadow-sm text-black"></textarea>
                        </div>
