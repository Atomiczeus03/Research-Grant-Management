                ...
                <div class="p-6">
                    <form action="{{ route('researchGrants.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="project_title" id="project_title" class="form-input rounded-md shadow-sm mt-1 block w-full border-blue-500 focus:ring-blue-300 focus:border-blue-300 text-black" required>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="grant_amount" id="grant_amount" class="form-input rounded-md shadow-sm mt-1 block w-full border-blue-500 focus:ring-blue-300 focus:border-blue-300 text-black" required>
                        </div>

                        <!-- Grant Provider -->
                        <div class="mb-4">
                            <label for="grant_provider" class="block text-sm font-medium text-white">Grant Provider</label>
                            <input type="text" name="grant_provider" id="grant_provider" class="form-input rounded-md shadow-sm mt-1 block w-full border-blue-500 focus:ring-blue-300 focus:border-blue-300 text-black" required>
                        </div>

                        <!-- Start Date -->
                        <div class="mb-4">
                            <label for="start_date" class="block text-sm font-medium text-white">Start Date</label>
                            <input type="date" name="start_date" id="start_date" class="form-input rounded-md shadow-sm mt-1 block w-full border-blue-500 focus:ring-blue-300 focus:border-blue-300 text-black" required>
                        </div>

                        <!-- Duration in Months -->
                        <div class="mb-4">
                            <label for="duration_months" class="block text-sm font-medium text-white">Duration (Months)</label>
                            <input type="number" name="duration_months" id="duration_months" class="form-input rounded-md shadow-sm mt-1 block w-full border-blue-500 focus:ring-blue-300 focus:border-blue-300 text-black" required>
                        </div>
