                ...
                <div class="p-6">
                    <form action="{{ route('academicians.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="users_id" id="name" class="form-select rounded-md shadow-sm mt-1 block w-full border-blue-500 focus:ring-blue-300 focus:border-blue-300 text-black" required>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" id="selected_name" class="form-input rounded-md shadow-sm mt-1 block w-full border-blue-500 focus:ring-blue-300 focus:border-blue-300 text-black" required readonly>
                        </div>

                        <!-- Email Field (Dynamically updated) -->
                        <div class="mb-4">
                            <label for="email" class="block font-medium text-sm text-white">Email</label>
                            <input type="email" name="email" id="email" class="form-input rounded-md shadow-sm mt-1 block w-full border-blue-500 focus:ring-blue-300 focus:border-blue-300 text-black" required readonly>
                        </div>

                        <!-- Staff Number Field -->
                        <div class="mb-4">
                            <label for="staff_number" class="block font-medium text-sm text-white">Staff Number</label>
                            <input type="text" name="staff_number" id="staff_number" class="form-input rounded-md shadow-sm mt-1 block w-full border-blue-500 focus:ring-blue-300 focus:border-blue-300 text-black" required>
                        </div>

                        <!-- College Field -->
                        <div class="mb-4">
                            <label for="college" class="block font-medium text-sm text-white">College</label>
                            <input type="text" name="college" id="college" class="form-input rounded-md shadow-sm mt-1 block w-full border-blue-500 focus:ring-blue-300 focus:border-blue-300 text-black" required>
                        </div>

                        <!-- Department Field -->
                        <div class="mb-4">
                            <label for="department" class="block font-medium text-sm text-white">Department</label>
                            <input type="text" name="department" id="department" class="form-input rounded-md shadow-sm mt-1 block w-full border-blue-500 focus:ring-blue-300 focus:border-blue-300 text-black" required>
                        </div>
