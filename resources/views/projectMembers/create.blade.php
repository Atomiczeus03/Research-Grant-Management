            ...
            <div class="bg-blue-300 text-gray-900 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <form action="{{ route('projectMembers.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            <label for="research_grant_id" class="block text-gray-900">Research Grant</label>
                            <select name="research_grant_id" id="research_grant_id" class="block w-full p-2 mt-2 rounded border border-blue-500 text-black">
                        ...
                        <div class="mb-4">
                            <label for="project_leader" class="block text-gray-900">Project Leader</label>
                            <input type="text" name="project_leader" id="project_leader" value="{{ $selectedGrant ? $selectedGrant->projectLeader->name : '' }}" readonly class="block w-full p-2 mt-2 rounded border border-blue-500 bg-blue-200 text-black">
                        </div>

                        <!-- Project Members Dropdown -->
                        <div class="mb-4" id="members-section" style="display: none;">
                            <label for="academicians" class="block text-gray-900">Project Members</label>
                            <select name="academicians[]" id="academicians" multiple class="block w-full p-2 mt-2 rounded border border-blue-500 text-black">
                        ...
                        <!-- Submit Button -->
                        <button type="submit" class="px-4 py-2 bg-blue-600 hover:bg-blue-500 text-white font-semibold rounded-md shadow-md mt-4">
                            Add Project Member
                        </button>
                    </form>
                </div>
